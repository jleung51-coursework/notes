...
\title{CMPT 373: Software Development Methods \\\medskip \Large A Course Overview}
...
\begin{document}
	...
	\input{./tex/teamwork.tex}
	\input{./tex/the-agile-paradigm.tex}
	\input{./tex/design-and-architecture.tex}
