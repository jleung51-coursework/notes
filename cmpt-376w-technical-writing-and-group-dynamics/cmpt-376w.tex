...
\title{CMPT 376W: Technical Writing and Group Dynamics \\\medskip \Large A Course Overview}
...
\begin{document}
	...
	\input{./tex/elements-of-text.tex}
	\input{./tex/writing.tex}
	\input{./tex/reviewing-papers.tex}
	\input{./tex/allegories.tex}
	\input{./tex/writing-samples.tex}
