...
\title{CMPT 320: Social Implications of a Computerized Society \\\medskip \Large A Course Overview}
...
\begin{document}
	...
	\input{./tex/freedom-of-speech.tex}
	\input{./tex/intellectual-property.tex}
	\input{./tex/life-with-technology.tex}
	\input{./tex/computer-crime.tex}
	\input{./tex/computers-in-the-workplace.tex}
	\input{./tex/economic-impact-of-technology.tex}
